                  ...
                  <tr class="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td class="py-3 px-4">
                      <span
                        ...
                        [ngClass]="getStateBadgeClass(alert.state?.name)"
                      >
...
export class AlertsListComponent implements OnInit {
  ...
  getStateBadgeClass(stateName?: string): string {
    ...
    if (s.includes('pendiente')) return 'bg-amber-100 text-amber-800 border border-amber-200';
    if (s.includes('proceso')) return 'bg-sky-100 text-sky-800 border border-sky-200';
    if (s.includes('resuelta') || s.includes('resuelto')) return 'bg-emerald-100 text-emerald-800 border border-emerald-200';
    if (s.includes('rechazada') || s.includes('cancelada')) return 'bg-rose-100 text-rose-800 border border-rose-200';
